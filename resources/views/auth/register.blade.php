<x-guest-layout>
    <div class="text-center mb-8">
        ...
        <p class="text-gray-500 text-sm mt-2">Join MyNotes today and start organizing your thoughts.</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-5">
        ...
        <div>
            ...
            <input id="name" type="text" name="name" value="{{ old('name') }}" required autofocus autocomplete="name" 
                class="w-full rounded-lg bg-gray-50 border-gray-200 focus:bg-white focus:border-amber-500 focus:ring-amber-500 text-gray-700 px-4 py-3 transition-colors" placeholder="John Doe">
        ...
        <div class="text-center mt-6">
            <p class="text-sm text-gray-600">
                Already registered? 
                <a href="{{ route('login') }}" class="font-medium text-amber-600 hover:text-amber-700">Sign in</a>
            </p>
        </div>
    </form>
</x-guest-layout>
